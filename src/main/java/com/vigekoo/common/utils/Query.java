...
import com.vigekoo.common.xss.SQLFilter;
...
public class Query extends LinkedHashMap<String, Object> {
    ...
    public Query(Map<String, Object> params){
        ...
        String sidx = params.get("sidx") == null ? "" : (String)params.get("sidx");
        String order = params.get("order") == null ? "asc" :(String)params.get("order");
